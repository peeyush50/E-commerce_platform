...
const UserManagement=()=> {
    ...
    const handleSubmit=(e)=>{
        ...
        //Reset the form aftere submission
        setFormData({
            name:"",
            email:"",
            password:"",
                ...
                <tbody>
                    {users.map((user)=>(
                        <tr key={user._id} className='border-b hover:bg-gray-50 '>
                            ...
                            <td className='p-4'>
                                <button onClick={()=> handleDeleteUser(user._id)} className='bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600'>Delete</button></td>
