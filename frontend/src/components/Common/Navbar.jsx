          ...
          <div className="flex items-center space-x-4">
            ...
            <button onClick={toggleCartDrawer}
             className="relative hover:text-black">
                ...
                {cartItemCount > 0 && (<span className="absolute -top-1 right-0 bg-rabbit-red text-white text-xs rounded-full px-2 py-0.5">{cartItemCount}</span>)}
     ...
     <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${
        ...
        <div className='p-4'>
            ...
            <nav className='space-y-4'>
                <Link to="/collections/all?gender=Men" onClick={toggleNavDrawer} className='block text-gray-600 hover:text-color-black'>Men</Link>
                <Link to="/collections/all?gender=Women" onClick={toggleNavDrawer} className='block text-gray-600 hover:text-color-black'>Women</Link>
                <Link to="/collections/all?category=Top Wear" onClick={toggleNavDrawer} className='block text-gray-600 hover:text-color-black'>Top Wear</Link>
                <Link to="/collections/all?category=Bottom Wear" onClick={toggleNavDrawer} className='block text-gray-600 hover:text-color-black'>Bottom Wear</Link>
            </nav>
        </div>
     </div>
